...
const projectsByLocale: Record<Locale, Project[]> = {
  fr: [
    ...
    },
    {
      ...
      stats: { teamSize: "Solo", downloads: "SaaS" },
      features: ["Next.js 16", "React 19", "TypeScript", "TailwindCSS v4", "PostgreSQL", "Prisma 6", "Stripe", "OpenAI", "Better Auth", "Redis"],
      stack: {
      ...
      highlights: [
        ...
        { title: "CV Lab IA", description: "Génération de CV sur mesure par mission avec personnalisation IA et export PDF" },
        { title: "Séquences automatisées", description: "Relances cadencées multi-canal avec templates et déclenchement automatique" },
        { title: "Calendrier intégré", description: "Vue calendrier des échéances, relances et rendez-vous liés aux missions" },
      ],
      links: {
    ...
    },
    {
      id: "00000",
      name: "Hyrun",
      description: "Application d'entraînement hybride HYROX & running avec coaching IA et nutrition personnalisée",
      longDescription:
      ...
      stats: { teamSize: "Solo", downloads: "SaaS" },
      features: ["Next.js 16", "React 19", "TypeScript", "TailwindCSS v4", "PostgreSQL", "Prisma 6", "Stripe", "OpenAI", "Better Auth", "Recharts"],
      stack: {
        frontend: ["Next.js 16 (Turbopack)", "React 19", "TypeScript 5.9", "TailwindCSS v4", "Shadcn/UI", "Zustand", "TanStack Query", "Recharts", "Motion"],
        backend: ["Prisma ORM", "Better Auth", "Stripe", "OpenAI SDK (Vercel AI)", "Resend", "React Email"],
        database: ["PostgreSQL", "Prisma ORM 6.16", "Redis (Upstash)"],
        devops: ["Vercel", "GitHub Actions CI/CD"],
        testing: ["Vitest", "Playwright", "React Testing Library"],
      },
      highlights: [
        { title: "Plans d'entraînement IA", description: "Génération de plans hybrides HYROX + running avec phases périodisées (Base → Taper)" },
        { title: "Substitutions intelligentes", description: "Propositions d'exercices alternatifs selon l'équipement disponible" },
        { title: "Nutrition IA", description: "Plans nutritionnels personnalisés avec macros, repas et listes de courses" },
        { title: "Coach IA", description: "Assistant conversationnel pour conseils d'entraînement personnalisés" },
        { title: "Calendrier unifié", description: "Suivi par session avec logs RPE, humeur, douleur, énergie et sommeil" },
      ],
      links: {
  ...
  en: [
    ...
    },
    {
      ...
      highlights: [
        ...
        { title: "AI CV Lab", description: "Tailored resume generation per mission with AI customization and PDF export" },
        { title: "Automated Sequences", description: "Multi-channel cadenced follow-ups with templates and automatic triggers" },
        { title: "Integrated Calendar", description: "Calendar view of deadlines, follow-ups and appointments linked to missions" },
      ],
      links: {
        website: "https://www.jobio.fr/",
      },
    },
    {
      id: "00000",
      name: "Hyrun",
      description: "Hybrid HYROX & running training app with AI coaching and personalized nutrition",
      longDescription:
      ...
      highlights: [
        { title: "AI Training Plans", description: "Hybrid HYROX + running plan generation with periodized phases (Base → Taper)" },
        { title: "Smart Substitutions", description: "Alternative exercise suggestions based on available equipment" },
        { title: "AI Nutrition", description: "Personalized nutrition plans with macros, meals and shopping lists" },
        { title: "AI Coach", description: "Conversational assistant for personalized training advice" },
        { title: "Unified Calendar", description: "Session tracking with RPE, mood, pain, energy and sleep logs" },
      ],
      links: {
        website: "https://hyrun.app/",
      },
