...
const profiles: Record<Locale, Profile> = {
  fr: {
    ...
    bio: "Dev React Native passionné par l’UI/UX et le sens du détail. Mon parcours, nourri par six années de management, m’aide à conjuguer rigueur technique, empathie et efficacité, du cadrage à la livraison.",
    avatar: "/images/yoann-profile-nobg.png",
    isAvailable: true,
    availabilityText: "Ouvert aux échanges",
    availabilityOptions: ["CDI", "Freelance", "Mission longue"],
    stats: [
      { label: "Téléchargements en production", value: "100K+" },
  ...
  en: {
    ...
    subtitle: "Paris, France",
    bio: "React Native developer with a passion for UI/UX and careful details. My path, shaped by six years in management, helps me combine technical rigor, empathy and efficiency from product framing through delivery.",
    avatar: "/images/yoann-profile-nobg.png",
    isAvailable: true,
    availabilityText: "Open to conversations",
    availabilityOptions: ["Full-time", "Freelance", "Long-term"],
    stats: [
      { label: "Production downloads", value: "100K+" },
