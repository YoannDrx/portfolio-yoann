...
const profiles: Record<Locale, Profile> = {
  fr: {
    ...
    lastName: "Andrieux",
    initials: "YA",
    title: "Développeur produit React / Next.js",
    subtitle: "Paris, France",
    bio: "Je transforme un besoin produit en parcours clair, architecture maintenable et livraison vérifiée. Mes projets montrent autant le cadrage et les arbitrages UX que le code React / Next.js, les tests, la sécurité et les limites assumées.",
  ...
  en: {
    ...
    lastName: "Andrieux",
    initials: "YA",
    title: "React / Next.js Product Developer",
    subtitle: "Paris, France",
    bio: "I turn product needs into clear journeys, maintainable architecture and verified delivery. My projects cover product framing and UX trade-offs as much as React / Next.js code, testing, security and explicit limitations.",
    avatar: "/images/yoann-profile-nobg.png",
    isAvailable: true,
