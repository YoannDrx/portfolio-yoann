...
const profiles: Record<Locale, Profile> = {
  ...
  en: {
    ...
    subtitle: 'Paris, France',
    bio: "Frontend and mobile developer passionate about UI/UX and attention to detail. My atypical background—shaped by several years in management—taught me to combine technical rigor, empathy, and efficiency. I help founders turn ideas into solid, useful products centered around the user experience.",
    avatar: '/images/avatar.jpg',
    isAvailable: true,
